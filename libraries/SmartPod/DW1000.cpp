	...
	if(_channel == CHANNEL_1 || _channel == CHANNEL_2) {
		if(_pulseFrequency == TX_PULSE_FREQ_16MHZ) {
			...
			if(_smartPower) {
				...
				writeValueToBytes(txpower, 0x3F3F3F3FL, LEN_TX_POWER);	//original 67
			}
		} else {
			// TODO proper error/warning handling
		}
		...
		if(_pulseFrequency == TX_PULSE_FREQ_16MHZ) {
			...
			if(_smartPower) {
				...
				writeValueToBytes(txpower, 0x3F3F3F3FL, LEN_TX_POWER);	//original 9A
			}
		} else {
			// TODO proper error/warning handling
		}
		...
		if(_pulseFrequency == TX_PULSE_FREQ_16MHZ) {
			...
			if(_smartPower) {
				...
				writeValueToBytes(txpower, 0x3F3F3F3FL, LEN_TX_POWER);	//original D1
			}
		} else {
			// TODO proper error/warning handling
		}
